...
2. **Ask the open questions one by one.** For each open question (in order), ask the user that question. Do NOT list all questions at once.
...
- [ ] **Open questions (if any) asked one by one and user answers collected**
