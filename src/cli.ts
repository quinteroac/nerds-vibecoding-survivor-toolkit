...
function buildHelpProgram(): Command {
  ...
  program.command("ideate").description("Start an ideation session via agent (optional preliminary step)");
  program.command("start").description("Start a new iteration, archiving flow files");
  program.command("define").description("Create requirement document via agent");
  program.command("refine").description("Refine requirement document or project context via agent");
  program.command("approve").description("Mark requirement, project-context, or prototype as approved");
  program.command("create").description("Generate project-context or prototype via agent");
  program.command("audit").description("Execute approved prototype audit tests via agent");
  program.command("refactor").description("Execute approved prototype refactor items via agent");
  program.command("sync").description("Copy .agents/skills/ to scaffold/.agents/skills/");
  program.command("init").description("Initialize toolkit files in the current directory");
  program.command("destroy").description("Remove files generated by nvst");
  program.command("write-json").description("Write a schema-validated JSON file");
  program.command("write-technical-debt").description("Append technical debt items to .agents/TECHNICAL_DEBT.md");
  return program;
}
